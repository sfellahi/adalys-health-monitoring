								...
								<ul class="dropdown-menu anti-dropdown-menu">
									...
									if ($nb_new_notif != 0) {
										...
										while ( $dn4 = mysqli_fetch_array ( $req5 ) ) {
											...
											?>
										<li><a
										href="accept_notif.php?parent=<?php echo $dn4['id_project_user']; ?>">
											<div class="notification_desc">
					...
					<ul>
						<li class="dropdown profile_details_drop"><a href="#"
							...
							aria-expanded="false">
								<div class="profile_img">
									<span class="prfil-img"><img
										src="upload/users/<?php echo $_SESSION['userid'];?>.jpg"
										alt=""> </span>
									<div class="clearfix"></div>
								</div>
						</a>
							...
							<ul class="dropdown-menu drp-mnu">
								...
								<li><a href="logout.php"><i class="fa fa-sign-out"></i> Se
										déconnecter</a></li>
							</ul></li>
					</ul>
				</div>
...
LEFT JOIN users ON project_user.id_user=users.id WHERE project_user.user_accept='yes' AND users.email='" . $_SESSION ['email'] . "'";
							...
							while ( $temp_projet_medecin = mysqli_fetch_array ( $result_projet_en_cours ) ) {
								...
								?>
                                                               ...
                                                               <li><a
								href="#"><i class="fa fa-file-text-o nav_icon"></i>Projets <?php echo $temp_projet_medecin['nom_project'];?><span
									class="fa arrow"></span></a> <!-- //nav-second-level -->
								<ul class="nav nav-second-level collapse">
									<li><a href="#"><i class="fa fa-user-md nav_icon"></i>Ajouter
											des patients<span class="fa arrow"></span></a>
...
$sql_formulaire = "SELECT project_formulaire.id_formulaire,formulaire.nom_formulaire,etat_formulaire ";
        ...
        $sql_formulaire .= "WHERE etat_formulaire!='En création' AND project_user.id_user=".$_SESSION['userid']." AND project_formulaire.id_project=".$temp_projet_medecin['id_project']." ";
								...
								while ( $temp_formulaire_en_cours = mysqli_fetch_array ( $result_liste_formulaire ) ) {									
									?>
												...
												<form action="ajout_patient.php" method="POST">
													<input type="hidden" id="formulaire" name="formulaire"
														value="<?php echo $temp_formulaire_en_cours['id_formulaire']; ?>">
													<input type="submit"
														style="background-color: transparent; color: white; border: none; padding-top: 7px; margin-left: 45px; font-size: 90%"
														value="Formulaire <?php echo $temp_formulaire_en_cours['nom_formulaire']; ?>">
												</form>
											</li>
                                                                  <?php } ?>                                                          
									...
									<li><a href="#"><i class="fa fa-hospital-o nav_icon"></i>Liste
											des patients<span class="fa arrow"></span></a>
										<ul class="nav nav-third-level collapse">
...
$sql_formulaire2 = "SELECT project_formulaire.id_formulaire,project_formulaire.id_project,formulaire.nom_formulaire,etat_formulaire ";
        ...
        $sql_formulaire2 .= "WHERE etat_formulaire!='En création' AND project_user.id_user=".$_SESSION['userid']." AND project_formulaire.id_project=".$temp_projet_medecin['id_project']." ";
								...
								while ( $temp_formulaire_en_cours3 = mysqli_fetch_array ( $result_liste_formulaire3 ) ) {
									...
									<li style="margin-left: 40px;">
										<form action="export_csv.php" method="POST">
											<input type="hidden" id="formulaire" name="formulaire"
												value="<?php echo $temp_formulaire_en_cours3['id_formulaire']; ?>">
											<input type="hidden" id="project" name="project"
												value="<?php echo $temp_formulaire_en_cours3['id_project']; ?>">
											<input type="submit"
												style="background-color: transparent; color: white; border: none; padding-top: 7px; margin-left: 45px; font-size: 90%"
												value="Formulaire <?php echo $temp_formulaire_en_cours3['nom_formulaire']; ?>">
										</form>
									</li>
									<?php
								}
