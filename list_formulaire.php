...
if(isset($_GET['parent']))
{
    ...
    ?>
    <tr>
    	<td><a href="formulaire.php?id=<?php echo $dnn1['id_formulaire']; ?>"><?php echo $dnn2['nom_formulaire']; ?></td>
    </tr>
    <?php
    }
    ?>
	</table>
	<a href="new_formulaire.php?parent=<?php echo $id; ?>" class="btn btn-primary">Nouveau Formulaire</a></div></div>
<?php
}